...
class MyCode {
    ...
    for(int i = 0; i < numOperations; i++) {
      ...
      /*
      Idea: 
      1. If x > top of minHeap (the insertion of x directly affects the top third, since it'll be in the top third)
      - Add x to minHeap
      - Poll the top of minHeap, add such to maxHeap
      2. Else 
      - Add x to maxHeap (since it'll not directly affects the top third). The 3rd condition will process such
      3. If maxHeap size % 3: 
